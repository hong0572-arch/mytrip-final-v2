...
export default function GuidePage() {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FD] font-sans relative overflow-hidden">
            {/* 배경 데코레이션 */}
            <div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-b from-indigo-50 via-purple-50 to-transparent -z-10" />
            ...
            <div className="max-w-md mx-auto px-6 pb-32 pt-4">
                ...
                >
                    <span className="inline-flex items-center gap-1 py-1 px-3 rounded-full bg-indigo-100 text-indigo-600 text-xs font-bold mb-4 animate-pulse">
                        <Zap size={12} fill="currentColor" /> My Trip Pro 100% 활용법
                    </span>
                    <h1 className="text-3xl font-black text-gray-900 leading-tight mb-3">
                        검색 없이 3초 완성!<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">AI 여행 플래너</span> 사용법
                    </h1>
                ...
                >
                    ...
                    <motion.div variants={fadeInUp} className="relative">
                        ...
                        <div className="relative bg-white rounded-3xl p-6 shadow-lg border border-gray-100 ml-4">
                            <div className="absolute -left-[27px] top-6 w-6 h-6 rounded-full bg-indigo-600 text-white flex items-center justify-center font-bold text-xs shadow-md z-10">1</div>
                            ...
                            <div className="space-y-3 text-gray-600 text-sm leading-relaxed">
                                ...
                                <div className="bg-indigo-50 p-3 rounded-xl text-xs font-medium text-indigo-700 mt-2">
                    ...
                    <motion.div variants={fadeInUp} className="relative">
                        <div className="absolute -left-3 top-0 bottom-0 w-0.5 bg-gray-200"></div>
                        <div className="relative bg-white rounded-3xl p-6 shadow-lg border border-gray-100 ml-4">
                            <div className="absolute -left-[27px] top-6 w-6 h-6 rounded-full bg-amber-500 text-white flex items-center justify-center font-bold text-xs shadow-md z-10">2</div>
                            ...
                            <div className="space-y-3 text-gray-600 text-sm leading-relaxed">
                                <p className="flex items-start gap-2">
                                    <BrainCircuit size={16} className="text-amber-400 mt-0.5 shrink-0" />
                    ...
                    <motion.div variants={fadeInUp} className="relative">
                        <div className="absolute -left-3 top-0 bottom-0 w-0.5 bg-gray-200"></div>
                        <div className="relative bg-white rounded-3xl p-6 shadow-lg border border-gray-100 ml-4">
                            <div className="absolute -left-[27px] top-6 w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold text-xs shadow-md z-10">3</div>
                            ...
                            <div className="space-y-3 text-gray-600 text-sm leading-relaxed">
                                ...
                                <div className="bg-gray-100 p-4 rounded-xl">
                                    ...
                                    <p className="text-xs">브라우저 메뉴에서 <span className="font-bold text-blue-600">'홈 화면에 추가'</span> 또는 <span className="font-bold text-blue-600">'앱 설치'</span>를 누르세요.</p>
                                </div>
                    ...
                    <motion.div variants={fadeInUp} className="relative">
                        {/* 마지막 라인은 없음 */}
                        <div className="relative bg-gradient-to-br from-rose-50 to-white rounded-3xl p-6 shadow-lg border border-rose-100 ml-4">
                            <div className="absolute -left-[27px] top-6 w-6 h-6 rounded-full bg-rose-500 text-white flex items-center justify-center font-bold text-xs shadow-md z-10">4</div>
                            ...
                            <div className="space-y-3 text-gray-600 text-sm leading-relaxed">
                                ...
                                <div className="bg-white p-3 rounded-xl border border-rose-100 shadow-sm text-center">
                                    <p className="text-rose-600 font-bold mb-1">🎁 초대 혜택</p>
                                    <p className="text-gray-800 font-medium">
                                        친구도 <span className="text-rose-600 font-black">1,000P</span>, 나도 <span className="text-rose-600 font-black">1,000P</span>
                                    </p>
                                </div>
                ...
                >
                    <button
                        onClick={() => router.push('/')}
                        className="w-full max-w-md mx-auto py-4 bg-gray-900 text-white rounded-2xl font-bold text-lg shadow-xl shadow-indigo-200 hover:bg-black transition-all active:scale-95 flex items-center justify-center gap-2"
                    >
