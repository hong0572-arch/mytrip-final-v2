                    ...
                    <div className="space-y-7">
                        ...
                        <div>
                            ...
                            <button
                                ...
                                className={`w-full py-3 rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-2 border ${isLuxury ? "bg-amber-500 text-white border-amber-500 shadow-md shadow-amber-200" : "bg-gray-50 text-gray-500 border-gray-100 hover:bg-gray-100"}`}
                            >
                                {isLuxury ? <><Crown size={16} fill="white" /> 초호화 럭셔리 여행 ON</> : <><Crown size={16} /> 초호화 여행 가상 체험하기</>}
                            </button>
                        </div>
                                ...
                                {isLuxury ? (
                                    <div className="flex-1 flex flex-col justify-center h-[52px]">
                                        <div className="flex items-center gap-2 text-amber-600 font-bold mb-1">
                                            <Sparkles size={16} /> VIP 전용 예산 적용
                                        </div>
                                        <p className="text-xs text-gray-500">2,000만원 ~ 5,000만원 (AI 자동 최적화)</p>
                                    </div>
                                ) : (
